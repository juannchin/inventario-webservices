...
<body>
    ...
    <br><br>
    <div>
        <form action="http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/deleteMarca.php" method="POST">
            &nbsp;&nbsp;<label>Id Producto</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="marca_id" name="marca_id" type="text" class="textbox"
    ...
    <br>
    <?php
    $apiurl = 'http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/listarMarcas.php';
