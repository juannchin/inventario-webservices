                        ...
                        <tr>
                            ...
                            <td>
                                <button id="Editar" type="submit" class="btn-agregar"><a class="btn-agregar"
                                        href="FormUpdateCategoria.php?id=<?php echo $marca['id']; ?>">Editar</a></button>
                                <button type="submit" class="btn-agregar"><a class="btn-agregar"
                                        href="deleteCategoria.php?id=<?php echo $marca['id']; ?>">Desactivar</a></button>
                            </td>
                        </tr>
                        <?php
                    endforeach;
