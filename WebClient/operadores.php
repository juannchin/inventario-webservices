...
<br><br>
<div id="main">
    <form method="POST" action="insertOperadores.php">
        <div class="par">
            &nbsp;&nbsp;<label>Usuario</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <button id="Editar" type="submit" class="btn-agregar"><a class="btn-agregar"
                                        href="FormUpdateOperador.php?id=<?php echo $marca['id']; ?>">Editar</a></button>
                                <button type="submit" class="btn-agregar"><a class="btn-agregar"
                                        href="deleteOperador.php?id=<?php echo $marca['id']; ?>">Desactivar</a></button>
                            </td>
                        </tr>
                        <?php
                    endforeach;
