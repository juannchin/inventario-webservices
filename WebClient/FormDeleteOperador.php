...
<body>
    ...
    <br><br>
    <div>
        <form action="http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/deleteOperadores.php" method="POST">
            &nbsp;&nbsp;<label>Id Operador</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="operador_id" name="operador_id" type="text" class="textbox"
    ...
    <br>
    <?php
    $apiurl = 'http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/listarOperadores.php';
