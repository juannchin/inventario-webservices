...
<body>
    ...
    <br><br>
    <div>
        <form action="http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/deleteCategoria.php" method="POST">
            &nbsp;&nbsp;<label>Id Categoria</label>&nbsp;&nbsp;&nbsp;&nbsp;
            <input id="categoria_id" name="categoria_id" type="text" class="textbox"
    ...
    <br>
    <?php
    $apiurl = 'http://localhost:8080/Proyecto%20ProgV/Proyecto%20ProgV/listarCategorias.php';
